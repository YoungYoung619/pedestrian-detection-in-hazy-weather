...
pic_train_dir_str = "inria_person/PICTURES_LABELS_TRAIN/PICTURES/"
label_train_dir_str = "inria_person/PICTURES_LABELS_TRAIN/ANOTATION/"

# pic_test_dir_str = "PICTURES_LABELS_TEST/PICTURES/"
# label_test_dir_str = "PICTURES_LABELS_TEST/ANOTATION/"

pic_test_dir_str = "inria_person/PICTURES_LABELS_TEST/PICTURES/"
label_test_dir_str = "inria_person/PICTURES_LABELS_TEST/ANOTATION/"
            ...
            if self.__for_what == "train":
                if self.__whether_aug:
                    ...
                    if len(bboxes) == 0:
                        ...
                        if np.count_nonzero(x_ <= 0.1) > 0 or np.count_nonzero(y_ <= 0.1) > 0:
                            continue
                img, bboxes = train_tools.normalize_data(img, bboxes, config.img_size)
                labels, bboxes = \
