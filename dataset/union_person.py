...
hazy_pic_train_dir_str = "hazy_person/PICTURES_LABELS_TRAIN/PICTURES/"
hazy_label_train_dir_str = "hazy_person/PICTURES_LABELS_TRAIN/ANOTATION/"

hazy_pic_test_dir_str = "hazy_person/PICTURES_LABELS_TEMP_TEST/PICTURES/"
hazy_label_test_dir_str = "hazy_person/PICTURES_LABELS_TEMP_TEST/ANOTATION/"

# pic_test_dir_str = "PICTURES_LABELS_TEST/PICTURES/"
# label_test_dir_str = "PICTURES_LABELS_TEST/ANOTATION/"

inria_pic_train_dir_str = "inria_person/PICTURES_LABELS_TRAIN/PICTURES/"
inria_label_train_dir_str = "inria_person/PICTURES_LABELS_TRAIN/ANOTATION/"

inria_pic_test_dir_str = "inria_person/PICTURES_LABELS_TEST/PICTURES/"
inria_label_test_dir_str = "inria_person/PICTURES_LABELS_TEST/ANOTATION/"
...
class provider(object):
    ...
    def __init__(self, for_what, batch_size=1, whether_aug=False):
        ...
        if for_what not in ["train", "predict", "evaluate"]:
            raise ValueError('pls ensure for_what must be "train"')
        else:
            self.__for_what = for_what
            data_root = os.path.dirname(__file__)
            if for_what == "train":
                ## load the imgs file name ##
                hazy_match = os.path.join(data_root, hazy_pic_train_dir_str + "*.jpg")
                inria_match = os.path.join(data_root, inria_pic_train_dir_str + "*.jpg")

                self.__hazy_imgs_name = glob.glob(hazy_match)
                self.__inria_imgs_name = glob.glob(inria_match)

                self.__imgs_name = self.__hazy_imgs_name + self.__inria_imgs_name
                ...
                self.__hazy_label_dir = os.path.join(data_root, hazy_label_train_dir_str)
                self.__inria_label_dir = os.path.join(data_root, inria_label_train_dir_str)
            # else:
            #     raise  ValueError('not support now...')
            else:
                ## load the imgs file name ##
                hazy_match = os.path.join(data_root, hazy_pic_test_dir_str + "*.jpg")
                inria_match = os.path.join(data_root, inria_pic_test_dir_str + "*.jpg")
                ...
                self.__hazy_label_dir = os.path.join(data_root, hazy_label_test_dir_str)
                self.__inria_label_dir = os.path.join(data_root, inria_label_test_dir_str)
...
if __name__ == '__main__':
    ...
    for step in range(100):
        imgs, labels, bboxes = dt.load_batch()
        ## do sth ##
        pass